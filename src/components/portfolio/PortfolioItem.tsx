    ...
    return (
        <div className="portfolio-item">
                <a className="portfolio-link" data-bs-toggle="modal" href={`#portfolioModal${index}`}>
                    ...
                    {portfolioItem.media_type > 0 && <video style={{ transform: `scaleY(${portfolioItem.transform_value})` }} id={`video-${index}`} crossOrigin="anonymous" className="profolio-video-player" width="350" muted autoPlay loop>
